        ...
        <div class="main-content container-fluid">
                                ...
                                <c:if test="${!empty AllsimCards}">
                                    <table id="table" class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th style="">numero</th>
                                            <th style="">operateur</th>
                                            <th style="">date d'activation</th>
                                            <th style="">Credit</th>
                                        ...
                                        <tbody>
                                        <c:forEach items="${AllsimCards}" var="sim">
                                            <tr id="<c:out value="${sim.idSimCard}"/>">

                                                <td class="cell-detail"><span><c:out value="${sim.simNumber}"/></span>
                                                </td>
                                                <td class="cell-detail"><span><c:out value="${sim.operator}"/></span>
                                                </td>
                                                <c:if test="${null== sim.activationDate}">
                                                    <td class="cell-detail"><span>none</span></td>
                                                </c:if>
                                                <c:if test="${!null== sim.activationDate}">
                                                    <td class="cell-detail"><span><c:out
                                                            value="${sim.activationDate}"/></span></td>
                                                </c:if>


                                                <td class="cell-detail"><span><c:out value="${sim.creditSms}"/></span>
                                                </td>
            ...
            <form:form action="/admin/ajoutSim" modelAttribute="card" method="post">
                ...
                <div class="form-group">
                    ...
                    <form:input type="text" path="simNumber" class="form-control" placeholder="nom"/>
                </div>
