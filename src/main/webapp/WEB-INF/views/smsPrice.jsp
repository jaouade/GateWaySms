...
<div class="be-wrapper be-fixed-sidebar">
                    ...
                    <div class="left-sidebar-content">
                        <ul class="sidebar-elements">
                            ...
                            <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span>CARTE SIM</span></a>
                                <ul class="sub-menu">
                                    <li><a href="/admin/cartedisp"><i class="icon mdi mdi-comment-edit"></i> Cartes
                                        disponibles </a>
                                    </li>
                                    <li><a href="/admin/cartedemande"><i class="icon mdi mdi-format-line-spacing"></i>
                                        Demandes </a>
                                    </li>
                            ...
                            <li class="parent"><a href=""><i
                                ...
                                <ul class="sub-menu">
                                    <li><a href="/admin/demanderecharge"> <i class="icon mdi mdi-comment-edit"></i>
                                        Demandes reçues</a>
                                    </li>
    ...
    <div class="be-content">
        <div class="main-content container-fluid">
                            ...
                            <div class="table-responsive noSwipe">
                                <c:if test="${!empty listSmsPrice}">
                                    <table id="table" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listSmsPrice}" var="smsprice">
                                            <tr id="<c:out value="${smsprice.idSmsPrice}"/>">


                                                <td class="cell-detail"><span><c:out value="${smsprice.tva}"/></span>
                                                </td>
                                                <td class="cell-detail"><span><c:out
                                                        value="${smsprice.unitPrice}"/></span>
                                                </td>


                                                <td class="text-right">
                                                    <div class="btn-group btn-space">
                                                        <a href="/admin/supsmsprice/${smsprice.idSmsPrice}"
                                                           type="button"
            ...
            <hr>
            <form:form action="/admin/addsmsprice" modelAttribute="smsprice" method="post">
                <div class="form-group">
                    <label for="recipient-name" class="control-label">TVA</label>
                    <form:input type="text" path="tva" class="form-control"
                                placeholder="login"/>
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="control-label">Prix unitaire</label>
                    <form:input type="text" path="unitPrice" class="form-control" placeholder="nom"/>
                </div>
