                                ...
                                <c:if test="${!empty listHistoriques}">
                                    <table id="table" class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th style="">DATE</th>
                                            <th style="">USER</th>
                                            <th style="">NOMBRE D'AUTHENTIFICATION</th>
                                            <th style="width:30%;"></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${listHistoriques}" var="log">
                                            <tr id="<c:out value="${sim.idSimCard}"/>">

                                                <td class="cell-detail"><span><c:out value="${log.date}"/></span>
                                                </td>
                                                <td class="cell-detail"><span><c:out
                                                        value="${log.loggedUser.client.name}"/></span>
                                                </td>
                                                <td class="cell-detail"><span><c:out value="${log.operation}"/></span>
                                                </td>
