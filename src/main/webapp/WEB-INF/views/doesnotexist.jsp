    ...
    <div class="be-content">
        <div class="main-content container-fluid">
            <div class="error-container">
                <div class="error-number">Does not exist</div>
                <div class="error-description">want us to resend you the  </div>
                <div class="error-goback-text">Would you like to go to login page?</div>
